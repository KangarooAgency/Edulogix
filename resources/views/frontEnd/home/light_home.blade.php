...
@if(isset($per["Image Banner"]) and $homePage)
    <?php
                ...
                <div class="banner-inner">
                    <div class="banner-content">
                        ...
                        <a class="primary-btn fix-gr-bg semi-large"
                           href="{{$homePage->link_url}}">{{$homePage->link_label}}</a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-5 text-md-right text-left mb-30-lg">
                                <a href="{{url('news-page')}}"
                                   class="primary-btn small fix-gr-bg">@lang('front_settings.browse_all')</a>
                            </div>
                        </div>
                        <div class="row">
                            @foreach($news as $value)
                                <div class="col-lg-4 col-md-6">
                                    <div class="news-item">
                                        <div class="news-img">
                                            <img class="img-fluid w-100 news-image" src="{{asset($value->image)}}"
                                                 alt="">
                                        </div>
                                        <div class="news-text">
                                            <p class="date">
                                ...
                                <div class="notice-board">
                                    @foreach($notice_board as $notice)
                                        <div class="notice-item">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#NoticeDetails{{$notice->id}}">
                                                <h4>{{$notice->notice_title}}</h4></a>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="academic-item">
                                        ...
                                        <div class="academic-text">
                                            ...
                                            <div>
                                                <a href="{{url('course-Details/'.$academic->id)}}" class="client-btn">Read
                                                    More</a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row mb-40">
                            ...
                            <div class="col-lg-6 col-md-5 text-md-right text-left mb-30-lg">
                                <a href="#" class="primary-btn small fix-gr-bg">@lang('front_settings.browse_all')</a>
                            </div>
                        </div>
                        <div class="row">
