    ...
    <div class="white-box">
        ...
        <thead>
            <tr>
                ...
                <th width="15%">Net Salary({{generalSetting()->currency_symbol}})</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    @if($value->payroll_status == 'P')
                    <a class="modalLink" data-modal-size="modal-lg" title="View Payslip Details" href="{{route('view-payslip', $value->id)}}"><button class="primary-btn small tr-bg"> View Payslip</button></a>
                    @endif
                </td>
            </tr>
            @endforeach
                ...
                <table id="table_id" class="table" cellspacing="0" width="100%">
                    ...
                    <tbody>
                       ...
                       <tr>
                        ...
                        <td>
                            <a class="modalLink" data-modal-size="modal-md" title="View Leave Details" href="{{route('view-leave-details', $value->id)}}"><button class="primary-btn small tr-bg"> View </button></a>
                        </td>
                    </tr>
                    @endforeach
                    @else 
        ...
        cellspacing="0">
            ...
            <tbody class="d-block">
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        <a href="{{route('download-staff-joining-letter',getFilePath3($staffDetails->joining_letter))}}">
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        <a href="{{route('download-resume',getFilePath3($staffDetails->resume))}}">
                            <button class="primary-btn tr-bg text-uppercase bord-rad">
                                Download
                                <span class="pl ti-download"></span>
                            </button>
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        <a href="{{route('download-other-document',getFilePath3($staffDetails->other_document))}}">
                            <button class="primary-btn tr-bg text-uppercase bord-rad">
                                Download
                                <span class="pl ti-download"></span>
                            </button>
                ...
                <tr class="d-flex">
                    ...
                    <td class="col-4">
                        <a class="primary-btn tr-bg text-uppercase bord-rad" href="{{route('download-staff-document',getFilePath3($value->file))}}">
                            Download
                                <span class="pl ti-download"></span>
                        </a>
                        <a class="primary-btn icon-only fix-gr-bg modalLink" title="Delete Document" data-modal-size="modal-md"  href="{{route('delete-staff-document-view',$value->id)}}">
                        ...
                        <div class="single-activity">
                            ...
                            <div class="sub-activity-box d-flex">
                                <h6 class="time text-uppercase">                                                                            
                                     {{$timeline->created_at != ""? dateConvert($timeline->created_at):''}}
                                </h6>
                                ...
                                <div class="close-activity">
                                    ...
                                    @if($timeline->file != "")
                                    <a href="{{route('download-staff-timeline-doc',getFilePath3($timeline->file))}}" class="primary-btn tr-bg text-uppercase bord-rad">
