                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <div class="primary_input">
                                            ...
                                            <label class="primary_input_label" for="">@lang('common.url')<span class="text-danger"> *</span></label>
                                ...
                                <div class="row mt-25">
                                    <div class="col-lg-12">
                                        <select class="primary_select  form-control{{ $errors->has('status') ? ' is-invalid' : '' }}" name="status">
                                                ...
                                                <option value="1" {{isset($visitor)? ($visitor->status == 1? 'selected':''):'selected'}}>@lang('common.active')</option>
                                                <option value="0"  {{isset($visitor)? ($visitor->status == 0? 'selected':''):''}}>@lang('common.inactive')</option>
                                        </select>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title">@lang('common.delete_social_media')</h4>
