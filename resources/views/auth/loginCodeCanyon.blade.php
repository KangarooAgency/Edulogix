...
<script>
        // Define arrays for each user role
        const studentCredentials = { username: 'student_username', password: 'student_password' };
        const teacherCredentials = { username: 'teacher_username', password: 'teacher_password' };
        const parentsCredentials = { username: 'parents_username', password: 'parents_password' };
        const adminCredentials = { username: 'admin_username', password: 'admin_password' };
        const superAdminCredentials = { username: 'superadmin_username', password: 'superadmin_password' };
        const accountantCredentials = { username: 'accountant_username', password: 'accountant_password' };
        const librarianCredentials = { username: 'librarian_username', password: 'librarian_password' };

        // Function to fill credentials based on selected role
        function fillCredentials(selectedRole) {
            let credentials;
            ...
            switch (selectedRole) {
                ...
                case 'Teacher':
                    ...
                    break;
                case 'Parents':
                    credentials = parentsCredentials;
                    break;
                case 'Admin':
            ...
            // Fill the text fields with credentials
