                        ...
                        <div class="">
                            ...
                            <div class="row mb-20">
                                ...
                                @if (in_array('roll_number', $fields))
                                    @if (generalSetting()->multiple_roll == 0)
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('student.roll')
                                                ...
                                                <input class="primary_input_field read-only-input" type="text"
                                                    ...
                                                    value="{{ $student->roll_no }}" readonly id="roll_number">
                                            ...
                                            <div class="col">
                                                <div class="primary_input">
                                                    <label class="primary_input_label" for="">@lang('common.date_of_birth')
                                                        @if (is_required('date_of_birth') == true)
                                                            <span class="text-danger"> *</span>
                                                        @endif
                                                    </label>
                                                    <input
                                                                ...
                                                                <div class="col-lg-12" id="sibling_section_div">
                                                                    <select class="primary_select " name="sibling_section"
                                                                        ...
                                                                        <option data-display="@lang('common.section') *"
                                                                            value="">@lang('common.section') *</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-25">
                                                                <div class="col-lg-12" id="sibling_name_div">
                                                                    <select class="primary_select "
                                                                        ...
                                                                        <option data-display="@lang('student.sibling') *"
                                                                            value="">@lang('student.sibling') *</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    @if (in_array('mothers_photo', $fields))
                                        <div class="col-lg-3">
                                            <div class="primary_input mb-15">
                                                ...
                                                <span class="text-danger">{{ $errors->first('mothers_photo') }}</span>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if (in_array('guardians_photo', $fields))
                                        <div class="col-lg-3">
                                            <div class="primary_input">
                                                ...
                                                <span class="text-danger">{{ $errors->first('guardians_photo') }}</span>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="row mb-20">
                                @if (in_array('national_id_number', $fields))
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('student.national_id_number')
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('student.document_01_title')
                                                @if (is_required('document_title_1') == true)
                                                    <span class="text-danger"> *</span>
                                                @endif
                                            </label>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('student.document_02_title')
                                                @if (is_required('document_title_2') == true)
                                                    <span class="text-danger"> *</span>
                                                @endif
                                            </label>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('student.document_03_title')
                                                @if (is_required('document_title_3') == true)
                                                    <span class="text-danger"> *</span>
                                                @endif
                                            </label>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="primary_input">
                                            <label class="primary_input_label" for="">@lang('student.document_04_title')
                                                @if (is_required('document_title_4') == true)
                                                    <span class="text-danger"> *</span>
                                                @endif
                                            </label>
