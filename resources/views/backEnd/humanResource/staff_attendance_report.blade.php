...
<style>
    ...
    #table_id_student_wrapper th,#table_id_student_wrapper td {
        text-align: center;
        padding-left: 8px;
        padding-right: 8px;
    }
            ...
            <div class="col-lg-12">
                ...
                <div class="white-box">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <label class="primary_input_label" for="">@lang('hr.role') <span class="text-danger">
                                    *</span></label>
                            <select class="primary_select form-control{{ $errors->has('role') ? ' is-invalid' : '' }}"
                                ...
                                <option value="{{$role->id}}"
                                    {{isset($role_id)? ($role->id == $role_id? 'selected':''):''}}>{{$role->name}}
                                </option>
                                @endforeach
                            </select>
                            @if ($errors->has('role'))
                        ...
                        <div class="col-lg-4">
                            <label class="primary_input_label" for="">@lang('hr.select_year') <span class="text-danger">
                                    *</span></label>
...
<section class="student-attendance up_admin_visitor">
    <div class="container-fluid p-0">
        ...
        <div class="white-box mt-5">
            <div class="row">
                <div class="col-lg-12">
                    <div class="lateday d-flex mt-4 justify-content-center">
