                            ...
                            <div class="">
                                <div class="row  pl-10">
                                    ...
                                    <div class="col-lg-5 mt-20">
                                        <p class="mb-2"><strong>@lang('common.date') & @lang('common.time'): </strong>{{@$take_online_exam->onlineExam !=""?
                                        dateConvert(@$take_online_exam->onlineExam->date):""}} {{@$take_online_exam->onlineExam!=""?
                                    ...
                                    <td width="80%">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="primary_input mt-20">
                                                <textarea readonly class="primary_input_field form-control read-only-input has-content mt-10" cols="0" rows="5" name="suitable_words_{{@$question->question_bank_id}}">{{@$student_answer->user_answer}}</textarea>
                                ...
                                @endphp
                                    ...
                                    @if ($online_exam_info->auto_mark==1 && $question->questionBank->type != "F")
                                        <td width="10%" class="text-right">
                                            <div class="mt-20 float-right">
                                                <input type="radio" disabled id="marks_{{@$question->questionBank!=""?@$question->questionBank->id:""}}_incorrect"  class="common-checkbox common-radio relationButton" name="marks[]{{@$question->questionBank->id}}"  {{@$student_answer->answer_status==0? 'checked': ''}}>
                                                <label for="marks_{{@$question->questionBank!=""?@$question->questionBank->id:""}}_incorrect"></label>
                                            </div>
                                        </td>
                                        <td width="10%" class="text-right">
                                            <div class="mt-20">
                                                <input type="radio" disabled id="marks_{{@$question->questionBank !=""?@$question->questionBank->id:""}}" class="common-checkbox common-radio relationButton" name="marks[]{{@$question->questionBank->id}}" value="{{@$question->questionBank!=""?@$question->questionBank->id:""}}" {{@$student_answer->answer_status==1? 'checked': ''}}>
                                    ...
                                    @else
                                        ...
                                        <td width="20%" class="text-right">
                                            <div class="mt-20 float-right">
                                                <input type="radio" id="marks_{{@$question->questionBank!=""?@$question->questionBank->id:""}}_incorrect"  class="common-checkbox common-radio relationButton" name="marks[]{{@$question->questionBank->id}}"  {{@$student_answer->answer_status==0? 'checked': ''}}>
                                                <label for="marks_{{@$question->questionBank!=""?@$question->questionBank->id:""}}_incorrect"></label>
                                            </div>
                                        </td>
                                        <td width="20%" class="text-right">
                                            <div class="mt-20">
                                                <input type="radio" id="marks_{{@$question->questionBank !=""?@$question->questionBank->id:""}}" class="common-checkbox common-radio relationButton" name="marks[]{{@$question->questionBank->id}}" value="{{@$question->questionBank!=""?@$question->questionBank->id:""}}" {{@$student_answer->answer_status==1? 'checked': ''}}>
                                                <label for="marks_{{@$question->questionBank!=""?@$question->questionBank->id:""}}"></label>
                                            </div>
                                        </td>
                                    @endif
