...
<section class="admin-visitor-area">
    <div class="container-fluid p-0">
       @if(isset($editData))
       {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => array('update-edit-item-receive-data',$editData->id), 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'item-receive-form']) }}
       @else
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-30">
                                    <div class="primary_input">
                                        <select class="primary_select  form-control{{ $errors->has('expense_head_id') ? ' is-invalid' : '' }}" name="expense_head_id" id="expense_head_id">
                                            ...
                                            <option value="{{$value->id}}"
                                                @if(isset($editData))
                                                @if($editData->expense_head_id == $value->id)
                                    ...
                                    <div class="col-lg-12 mb-30">
                                        <div class="primary_input">
                                            <select class="primary_select  form-control" name="payment_method" id="edit_payment_method">
                                ...
                                <div class="col-lg-12 mb-20">
                                    <div class="primary_input">
                                        <select class="primary_select  form-control{{ $errors->has('supplier_id') ? ' is-invalid' : '' }}" name="supplier_id" id="supplier_id">
                                            <option data-display="@lang('common.select_supplier') *" value="">@lang('common.select')</option>
                                            @if(isset($suppliers))
                                    ...
                                    <div class="col-lg-12 mb-20">
                                        <div class="primary_input">
                                            <select class="primary_select  form-control{{ $errors->has('store_id') ? ' is-invalid' : '' }}" name="store_id" id="store_id">
                                                <option data-display="@lang('common.select_store')/@lang('inventory.warehouse') *" value="">@lang('common.select')</option>
                                                @if(isset($itemStores))
                                        ...
                                        <div class="col-lg-12 no-gutters input-right-icon mb-30">
                                            <div class="col">
                                                <div class="primary_input">
                                                    <input class="primary_input_field  primary_input_field date form-control form-control{{ $errors->has('from_date') ? ' is-invalid' : '' }}"  id="receive_date" type="text"
                                                    name="receive_date" value="{{isset($editData)? date('m/d/Y', strtotime($editData->receive_date)): ''}}" autocomplete="off">
                                                    <label class="primary_input_label" for="">@lang('inventory.receive_date') <span></span> </label>
                  ...
                  @foreach($editDataChildren as $editDataValue)
                      <tr id="row{{++$i}}" class="{{$j++}}">
                        <td>
                            ...
                            <div class="primary_input">
                                <select class="primary_select  form-control{{ $errors->has('item_id') ? ' is-invalid' : '' }}" name="item_id[]" id="productName{{$i}}">
