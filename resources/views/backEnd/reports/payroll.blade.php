                ...
                <div class="main-title">
                    ...
                    @endforeach
                                    ...
                                    <tr>
                                        ...
                                        <th>{{currency_format($basic_salary)}}</th>
                                        <th>{{currency_format($earnings)}}</th>
                                        <th>{{currency_format($deductions)}}</th>
                                        <th>{{currency_format(@$leaveDeductions->salary_deduct)}}</th>
                                        <th>{{currency_format($gross_salary)}}</th>
                                        <th>{{currency_format($tax)}}</th>
                                        <th>{{currency_format($net_salary)}}</th>
                                    </tr>
                                    </tfoot>
                                </table>
                                </x-table>
