...
<div class="container-fluid" id="pdf">
    ...
    <table class="table table-bordered table-striped" style="width: 100%; table-layout: fixed">
        ...
        <tr>
            ...
            <th style="padding: 2px;">@lang('common.subject')</th>
            <th style="padding: 2px;">@lang('common.class_Sec')</th>
            <th style="padding: 2px;">@lang('common.teacher')</th>         
            <th style="padding: 2px;">@lang('common.time')</th>         
            <th style="padding: 2px;">@lang('common.duration')</th>         
            <th style="padding: 2px;">@lang('common.room')</th>
        </tr>
