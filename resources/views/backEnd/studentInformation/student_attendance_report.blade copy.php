                ...
                <div class="white-box">
                    {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'student_attendance_report_search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'search_student']) }}
                        <div class="row">
                            ...
                            <div class="col-lg-3 mt-30-md">
                                <select class="primary_select {{ $errors->has('month') ? ' is-invalid' : '' }}" name="month">
    ...
    <div class="container-fluid p-0">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <table id="table_id_student" style="margin-bottom:25px" class="table table-responsive" cellspacing="0" width="100%">
                    <thead>
                        <tr>
