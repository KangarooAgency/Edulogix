                    ...
                    <div class="white-box">
                        <div class="">
                            ...
                            <div class="row mb-20">
                                <div class="col-lg-3">
                                    <div class="primary_input">
                                        <label class="primary_input_label" for="">@lang('student.document_01_title') @if (is_required('document_title_1') == true)
                                                <span class="text-danger"> *</span>
                                            @endif
                                        </label>
                                ...
                                <div class="col-lg-3">
                                    <div class="primary_input">
                                        <label class="primary_input_label" for="">@lang('student.document_02_title') @if (is_required('document_title_2') == true)
                                                <span class="text-danger"> *</span>
                                            @endif
                                        </label>
                                ...
                                <div class="col-lg-3">
                                    <div class="primary_input">
                                        <label class="primary_input_label" for="">@lang('student.document_03_title') @if (is_required('document_title_3') == true)
                                                <span class="text-danger"> *</span>
                                            @endif
                                        </label>
                                ...
                                <div class="col-lg-3">
                                    <div class="primary_input">
                                        <label class="primary_input_label" for="">@lang('student.document_04_title') @if (is_required('document_title_4') == true)
                                                <span class="text-danger"> *</span>
                                            @endif
                                        </label>
