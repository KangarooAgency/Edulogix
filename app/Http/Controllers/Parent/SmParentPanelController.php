...
class SmParentPanelController extends Controller
{
    ...
    public function parentDashboard()
    {
        try {
            ...
            $my_childrens = Auth::user()->parent->childrens->load('assignSubjects','assignSubject','studentOnlineExams','studentRecords','examSchedule');
            ...
            return view('backEnd.parentPanel.parent_dashboard', compact('holidays', 'calendar_events', 'events', 'totalNotices','my_childrens'));
        } catch (\Exception $e) {       
