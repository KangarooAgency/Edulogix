                    ...
                    <table id="table_id" class="table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($walletAmounts as $key=>$walletAmount)
                                <tr>
                                    ...
                                    <td>
                                        {{currency_format($walletAmount->amount)}}
                                        @php
                                                        ...
                                                        <div class="col-lg-12 text-center">
                                                            ...
                                                            @if (@$for_pdf=="pdf")
                                                                <div class="mb-5">
                                                                    ...
                                                                    @endif
                                                                    @if (isset($status) && $status =='reject')
                                                                        @if(userPermission("wallet.reject-diposit"))
                                                                            <a href="{{url(@$walletAmount->file)}}" download>@lang('common.download') <span class="pl ti-download"></span></a>
                                                                        @endif
                                                                    @endif
                                                                    @if (isset($status) && $status =='pending')
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="walletAmount">{{currency_format($totalAmount)}}</td>
                                <td class="walletAmount"></td>
                                <td class="walletAmount"></td>
                                <td class="walletAmount"></td>
                                <td class="walletAmount"></td>
