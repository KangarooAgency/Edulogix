                        ...
                        @if($feesTranscation->payment_method == "Cash" || $feesTranscation->payment_method == "Cheque" || $feesTranscation->payment_method == "Bank")
                            {{ Form::open(['class' => 'form-horizontal', 'route' => 'fees.change-method', 'method' => 'POST' ,'id'=>'feesChangeMethod']) }}
                                ...
                                <div class="mt-30-md">
                                    <div class="row">
                                        <div class="com-md-10">
                                            <select class="primary_select form-control {{ $errors->has('change_method') ? ' is-invalid' : '' }} changeMethod" name="change_method">
                                    ...
                                    <div class="row">
                                        <div class="bankInfo mt-20 d-none">
                                            <select class="primary_select form-control {{ $errors->has('bank_id') ? ' is-invalid' : '' }} bankId" name="bank_id">
